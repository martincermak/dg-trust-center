          ...
          <div className="space-y-4">
            ...
            <div className="card mt-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                For privacy-related requests, erasure requests, or any other
                GDPR questions, reach our data protection contact directly.
              </p>
              <a
              ...
              >
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="14" height="10" rx="1.5" /><path d="M1 4l7 5 7-5" /></svg>
