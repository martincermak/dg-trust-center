      ...
      <div className="max-w-content mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs">
            <a href="https://deltagreen.energy" className="hover:text-white transition-colors">
              deltagreen.energy
            </a>
            <a href="https://deltagreen.energy/privacy" className="hover:text-white transition-colors">
              Privacy Policy
            </a>
            <a href="https://deltagreen.energy/cookies" className="hover:text-white transition-colors">
              Cookie Policy
            </a>
            <a href="mailto:security@deltagreen.energy" className="hover:text-white transition-colors">
