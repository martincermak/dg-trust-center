const PRACTICES = [
  { title: "Encryption", body: "All data in transit is protected by TLS 1.2 or higher. Data at rest is encrypted using AES-256. Encryption keys are managed through a dedicated key management service with rotation policies.", icon: "lock" },
  { title: "Access Control & MFA", body: "Role-based access control (RBAC) limits data access to personnel with a documented business need. Multi-factor authentication is enforced for all internal systems and production environments.", icon: "shield" },
  ...
  { title: "Third-Party Risk", body: "Vendors and subprocessors are assessed before onboarding and reviewed periodically. We maintain a public subprocessor list with notification for material changes.", icon: "chain" },
];
  ...
  return (
    <section id="security" className="py-20 px-6 bg-dg-surface">
      <div className="max-w-content mx-auto">
        ...
        <p className="section-body mt-3 max-w-2xl">Our ISO 27001-aligned ISMS covers the full lifecycle of information security. Below is a high-level overview of key control areas.</p>
